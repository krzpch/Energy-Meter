...
protected:
    virtual uint8_t u8x8_gpio_and_delay(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
    {
    ...
    virtual uint8_t u8x8_byte_hw_interface(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
    {
        switch(msg) {
...
display::display(const u8g2_cb_t *rotation) : DISPLAY(rotation)
{
}
